...
def getGpuUsage():
	gpuOut2 = os.popen("nvidia-smi --query-gpu=utilization.gpu,memory.total,memory.used,gpu_name --format=csv").read()
...
#memUsed, memTot = getMemUsage()
#cpuUsage = getCpuUsage()
#gpuDat = getGpuProc()
#gpuUsage = getGpuUsage()

#print(cpuUsage )
#print(memUsed/memTot * 100)
#print(gpuDat)
#print(gpuUsage)
